...
## 16. General Troubleshooting Principle

Do not rely on a single artifact.
...
This reduces the risk of incorrectly interpreting an isolated timestamp, registry alert, or PowerShell parameter as proof of compromise.
